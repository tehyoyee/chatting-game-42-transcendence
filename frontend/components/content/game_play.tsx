	...
	useEffect(() => {
		...
		var Game: GameType = {
			...
			draw: function () {
				...
				let tmpObj: any = {paddle1X: 0, paddle1Y: 0, paddle2X: 0, paddle2Y: 0};
				...
				let tmpObj2: any = {ballX: 0, ballY: 0};
				Sock.gameSocket?.on('gamingBall', tmpObj2);
				// Draw the Ai
				this.context.fillRect(
				tmpObj2.paddle2X,
				tmpObj2.paddle2Y,
				...
				let tmpObj3: any = {score1: 0, score2: 0};
				Sock.gameSocket?.on('gamingScore', tmpObj3);
				// Draw the players score (left)
				this.context.fillText(
				tmpObj3.score1.toString(),
