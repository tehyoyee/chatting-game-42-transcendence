...
export default function ChatControl({ userList }: { userList: IChatMate[] }) {
    ...
    <div style={{textAlign: 'center',}}>
      ...
      <div>
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            chatSocket && requestUser(ControlType.Ban, user, chatSocket);
          }}
        ...
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            chatSocket && requestUser(ControlType.Kick, user, chatSocket);
          }}
          className={styles.normalButton}
        >
          {"킥"}
        ...
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            chatSocket && requestUser(ControlType.Mute, user, chatSocket);
          }}
          className={styles.normalButton}
        >
          {"뮤트"}
        ...
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            chatSocket && requestUser(ControlType.SetAdmin, user, chatSocket);
          }}
          className={styles.normalButton}
        >
          {"운영자 권한 부여"}
      ...
      <TextInputForm
        onSubmit={() => {
          chatSocket && setPwd(user, chatSocket);
        }}
